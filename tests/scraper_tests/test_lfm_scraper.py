...
@pytest.mark.parametrize(
    ...
    [
        ([RecommendationType.ALBUM], [call(rec_type=RecommendationType.ALBUM)]),
        ([RecommendationType.TRACK], [call(rec_type=RecommendationType.TRACK)]),
        (
            [RecommendationType.ALBUM, RecommendationType.TRACK],
            [call(rec_type=RecommendationType.ALBUM), call(rec_type=RecommendationType.TRACK)],
        ),
    ],
)
