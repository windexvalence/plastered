...
from tests.conftest import valid_app_config, valid_config_filepath
...
def test_cli_scrape_command(valid_config_filepath: str, valid_app_config: AppConfig) -> None:
