...
from utils.http_utils import request_musicbrainz_api
from utils.logging_utils import get_custom_logger
from utils.red_utils import RedReleaseType
...
class MBRelease(object):
    def __init__(self, mbid: str, title: str, artist: str, primary_type: str, first_release_year: int, release_date: str, label: str, catalog_number: str, release_group_mbid: str):
        self._mbid = mbid
        self._title = title
        self._artist = artist
